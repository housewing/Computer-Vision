...
int main(int argc, char** argv[])
{
	...
	//A.push_back(Point(44, 207));
	//A.push_back(Point(546, 186));
	//A.push_back(Point(546, 498));
	//A.push_back(Point(44, 495));
	...
	//B.push_back(Point(580, 184));
	//B.push_back(Point(1212, 104));
	//B.push_back(Point(1224, 526));
	//B.push_back(Point(580, 500));

	Mat mat8x8 = (Mat_<float>(8, 8) <<	A[0].x, A[0].y, 1, 0, 0, 0, -B[0].x*A[0].x, -B[0].x*A[0].y,
										0, 0, 0, A[0].x, A[0].y, 1, -B[0].y* A[0].x, -B[0].y*A[0].y,
										A[1].x, A[1].y, 1, 0, 0, 0, -B[1].x*A[1].x, -B[1].x*A[1].y,
										0, 0, 0, A[1].x, A[1].y, 1, -B[1].y* A[1].x, -B[1].y*A[1].y,
										A[2].x, A[2].y, 1, 0, 0, 0, -B[2].x* A[2].x, -B[2].x*A[2].y,
										0, 0, 0, A[2].x, A[2].y, 1, -B[2].y* A[2].x, -B[2].y*A[2].y,
										A[3].x, A[3].y, 1, 0, 0, 0, -B[3].x* A[3].x, -B[3].x*A[3].y,
										0, 0, 0, A[3].x, A[3].y, 1, -B[3].y* A[3].x, -B[3].y*A[3].y);

	Mat mat8x1 = (Mat_<float>(8, 1) << B[0].x, B[0].y, B[1].x, B[1].y, B[2].x, B[2].y, B[3].x, B[3].y);
